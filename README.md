[![](apps/web/app/opengraph-image.png)](https://www.getmailx.com)

<p align="center">
  <a href="https://www.getmailx.com">
    <h1 align="center">MailX - Your AI Email Assistant</h1>
  </a>
  <p align="center">
    Open source email app to reach MailX fast.
    <br />
    <a href="https://www.getmailx.com">Website</a>
    ·
    <a href="https://www.getmailx.com/discord">Discord</a>
    ·
    <a href="https://github.com/elie222/mailx/issues">Issues</a>
  </p>
</p>

## About

There are two parts to MailX:
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Felie222%2Fmailx&env=NEXTAUTH_SECRET,GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET,GOOGLE_ENCRYPT_SECRET,GOOGLE_ENCRYPT_SALT,UPSTASH_REDIS_URL,UPSTASH_REDIS_TOKEN,GOOGLE_PUBSUB_TOPIC_NAME,DATABASE_URL)

Thanks to Vercel for sponsoring MailX in support of open-source software.
...
Learn more in our [docs](https://docs.getmailx.com).
...
[![MailX demo](/video-thumbnail.png)](http://www.youtube.com/watch?v=hfvKvTHBjG0)
...
To request a feature open a [GitHub issue](https://github.com/elie222/mailx/issues). If you don't have a GitHub account you can request features [here](https://www.getmailx.com/feature-requests). Or join our [Discord](https://www.getmailx.com/discord).

## Getting Started for Developers

We offer a hosted version of MailX at [https://www.getmailx.com](https://www.getmailx.com). To self-host follow the steps below.

### Contributing to the project

You can view open tasks in our [GitHub Issues](https://github.com/elie222/mailx/issues).
Join our [Discord](https://www.getmailx.com/discord) to discuss tasks and check what's being worked on.
